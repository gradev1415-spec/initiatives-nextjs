...
export default function Overlay({ x, children }) {
  ...
  return (
    <div onClick={x} style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.5)", zIndex:200, display:"flex", alignItems:"center", justifyContent:"center", padding:20 }}>
      <div onClick={function(e) { e.stopPropagation(); }} style={{ background:T.sf, border:"1px solid "+T.bd, borderRadius:16, padding:28, minWidth:360, maxWidth:560, maxHeight:"80vh", overflow:"auto" }}>
        {children}
      </div>
    </div>
  );
