...
export default function WizardPage(p){
  ...
  var iS={width:"100%",padding:"10px 14px",borderRadius:6,border:"1px solid "+T.bd,background:T.ib,color:T.tx,fontSize:13,fontFamily:"inherit",outline:"none",boxSizing:"border-box",transition:"border-color 0.3s"};
    ...
    <div ref={wizRef} onKeyDown={handleWizKey} style={{padding:"24px 32px",maxWidth:900,margin:"0 auto"}}>
      ...
      <div style={{minHeight:340}}>
        {step===1&&(<div style={{display:"flex",flexDirection:"column",gap:18,animation:"wizFadeUp 0.4s ease"}}>
          ...
          <div><label style={{fontSize:11,color:T.td,display:"block",marginBottom:6,textTransform:"uppercase"}}>Description</label><textarea value={desc} onChange={function(e){sDesc(e.target.value);}} placeholder="What is this initiative for?" rows={2} style={{width:"100%",padding:"10px 14px",borderRadius:8,border:"1px solid "+T.bd,background:T.ib,color:T.tx,fontSize:13,fontFamily:"inherit",outline:"none",resize:"vertical",boxSizing:"border-box"}}/></div>
        ...
        {step===2&&(<div style={{animation:"wizFadeUp 0.4s ease"}}>
          ...
          {p.deptTree.map(function(region){
            ...
            {(exp[region.id]||someSel)&&<div style={{paddingLeft:28}}>{region.ch.map(function(d2,di){var sel=selD.find(function(x){return x.id===d2.id;});return (<div key={d2.id} onClick={function(){togDept(d2);}} style={{display:"flex",alignItems:"center",gap:10,padding:"6px 12px",cursor:"pointer",borderRadius:6,background:sel?T.ad:"transparent",marginBottom:1,transition:"all 0.2s",animation:"wizSlideIn 0.3s ease",animationDelay:(di*40)+"ms",animationFillMode:"backwards"}}><div style={{width:15,height:15,borderRadius:3,border:"1.5px solid "+(sel?T.ac:T.bl),background:sel?T.ac:"transparent",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,transition:"all 0.2s"}}>{sel&&<span style={{color:"#FFFFFF",fontSize:9,fontWeight:700,animation:"wizPop 0.2s ease"}}>{CHK}</span>}</div><span style={{fontSize:13,color:sel?T.tx:T.tm}}>{d2.nm}</span>{sel&&<span style={{fontSize:10,color:T.ac,marginLeft:"auto",animation:"wizSlideIn 0.3s ease"}}>~22 employees</span>}</div>);})}</div>}
          </div>);})}
        ...
        {step===25&&(<div style={{animation:"wizFadeUp 0.4s ease"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14,marginBottom:16}}>
            {(function(){
              ...
              return [
                <div key="multi" onClick={function(){sUseLayout(true);}} style={{padding:"20px 22px",borderRadius:8,border:"2px solid "+(multiSel?T.ac:T.bd),background:T.sf,cursor:"pointer",transition:"all 0.3s ease",position:"relative",overflow:"hidden",display:"flex",alignItems:"center",gap:20}}>
                ...
                <div key="uni" onClick={function(){sUseLayout(false);sSelLayout(null);}} style={{padding:"20px 22px",borderRadius:8,border:"2px solid "+(uniSel?T.ac:T.bd),background:T.sf,cursor:"pointer",transition:"all 0.3s ease",position:"relative",overflow:"hidden",display:"flex",alignItems:"center",gap:20}}>
            ...
            return (<div style={{animation:"wizFadeUp 0.3s ease"}}>
              {hasTemplates&&(<div style={{marginBottom:14}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:10}}>
                  {templates.map(function(tmpl){var sel=selLayout===tmpl.id;return (
                    <div key={tmpl.id} onClick={function(){sSelLayout(tmpl.id);loadTemplateReqs(tmpl.id);}} style={{padding:"12px 14px",borderRadius:8,border:"2px solid "+(sel?T.ac:T.bd),background:sel?T.ad:"transparent",cursor:"pointer",transition:"all 0.3s",animation:"wizSlideIn 0.3s ease"}}>
                  ...
                  <div onClick={function(){sSelLayout("new");}} style={{padding:"12px 14px",borderRadius:8,border:"2px dashed "+(selLayout==="new"?T.ac:T.bd),background:selLayout==="new"?T.ad:"transparent",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",minHeight:60,transition:"all 0.3s"}}>
                    <span style={{fontSize:12,color:selLayout==="new"?T.ac:T.td,fontWeight:500}}>+ Create New Layout</span>
                  </div>
                </div>
              </div>)}
              {(!hasTemplates||selLayout==="new")&&(<div style={{marginBottom:14,padding:14,borderRadius:8,border:"1px solid "+T.bd,background:T.sa+"60",animation:"wizFadeUp 0.3s ease"}}>
              ...
              {selLayout&&getLayoutAreas().length>0&&(<div style={{animation:"wizFadeUp 0.3s ease"}}>
                ...
                {getLayoutAreas().map(function(area,ai){
                  ...
                  return (<div key={area.aid} style={{marginBottom:8,borderRadius:8,border:"1px solid "+(isExp?T.ac+"40":T.bd),background:isExp?T.ad+"20":"transparent",overflow:"hidden",transition:"all 0.3s",animation:"wizSlideIn 0.25s ease",animationDelay:(ai*40)+"ms",animationFillMode:"backwards"}}>
                    {/* Compact area header */}
        ...
        {step===3&&(<div style={{animation:"wizFadeUp 0.4s ease"}}>
          ...
          {(function(){
            ...
            return deptOrder.map(function(dId,dIdx){
              ...
              return (<div key={dId} style={{marginBottom:8,borderRadius:8,border:"1px solid "+T.bd,overflow:"hidden"}}>
        ...
        {step===4&&roleSrc==="jobprofile"&&(<div style={{animation:"wizFadeUp 0.4s ease"}}>
          {getUniqueProfiles().map(function(prof,pi){
            ...
            return (<div key={prof.id} style={{marginBottom:10,borderRadius:8,border:"1px solid "+T.bd,animation:"wizSlideIn 0.3s ease",animationDelay:(pi*80)+"ms",animationFillMode:"backwards"}}>
              {/* Profile header */}
        ...
        {step===timelineN&&(<div style={{animation:"wizFadeUp 0.4s ease"}}>
          ...
          <div style={{marginTop:18,padding:14,borderRadius:8,border:"1px solid "+T.bd,background:T.sa+"80"}}>
        ...
        {step===analysisN&&(<div style={{animation:"wizFadeUp 0.4s ease"}}>
          <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:14,padding:"10px 14px",borderRadius:8,background:T.sa,border:"1px solid "+T.bd}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginTop:24,paddingTop:14,borderTop:"1px solid "+T.bd}}>
        <button onClick={function(){var prev=prvStep(step);if(prev!==null)goToStep(prev);else p.onClose();}} style={{padding:"8px 16px",borderRadius:6,border:"1px solid "+T.bd,background:"transparent",color:T.tm,cursor:"pointer",fontSize:12,fontFamily:"inherit",transition:"all 0.2s"}}>{prvStep(step)!==null?"Back":"Cancel"}</button>
        <button disabled={!canNext()} onClick={function(){var nxt=nxtStep(step);if(nxt!==null)goToStep(nxt);else doComplete();}} style={{padding:"8px 22px",borderRadius:6,border:"none",cursor:canNext()?"pointer":"default",background:canNext()?T.ac:T.sa,color:canNext()?"#FFFFFF":T.td,fontSize:13,fontWeight:600,fontFamily:"inherit",opacity:canNext()?1:0.5,transition:"all 0.3s ease",animation:canNext()&&!isLast(step)?"wizGlow 2s ease infinite":"none"}}>{step===analysisN?(analysisDone?"Create Initiative":"Analyzing"+ELLIP):"Continue"}</button>
      </div>
