...
export function mkIni(){return [
  ...
  {id:"i1",nm:"Lyngby Flagship",ds:"Flagship POWER store in Lyngby shopping centre. Largest store in the Capital Region with full department coverage and dedicated service desk. Benchmark location for new concepts.",tp:"Operational",st:"active",
    depts:[
      {did:"d1",dn:"Lyngby",layout:"lt1",areas:[
        {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:4},{s:"Product Knowledge",lvl:4}],certReqs:["AV Specialist Cert"],roles:[
        ...
        {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:4},{s:"Network Basics",lvl:3}],certReqs:["IT Support Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:6,ql:5,gp:1},
        ...
        {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:["Electrical Safety Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:4,ql:3,gp:1}
        ]},
    ...
    rev:42000000,inv:1200000,sd:"Q1 2025",td:"Q4 2025",_skillRd:82,_certRd:78,
    sg:[{s:"Computer Setup",n:2,i:"Medium"},{s:"Product Knowledge",n:3,i:"Low"}],
    cg:[{c:"AV Specialist Cert",n:1,i:"Medium",exp:"2025-11-01"}],
    certs:[{c:"Electrical Safety Cert",total:22,valid:20,exp30:1,exp60:1,expired:0},{c:"AV Specialist Cert",total:8,valid:7,exp30:0,exp60:1,expired:0},{c:"IT Support Cert",total:6,valid:6,exp30:0,exp60:0,expired:0}],
    hist:[{q:"Q1 2025",rd:78,staff:85,skill:74,cert:72},{q:"Q2 2025",rd:83,staff:90,skill:80,cert:76},{q:"Q3 2025",rd:88,staff:93,skill:85,cert:82}]
  },
  ...
  {id:"i2",nm:"Norreport City Store",ds:"Compact city-centre POWER express store at Norreport Station. High foot traffic, limited floor space, focused product selection. No separate departments — all staff rotate across the floor.",tp:"Operational",st:"active",
    ...
    rev:18000000,inv:400000,sd:"Q2 2025",td:"Q4 2025",_skillRd:90,_certRd:88,
    sg:[{s:"Inventory Management",n:1,i:"Low"}],cg:[],
  ...
  {id:"i3",nm:"West Coast Expansion",ds:"Two-store expansion into Aalborg Storcenter (ramping up, partially staffed) and Esbjerg Storcenter (newly opened, critical gaps). Shared training resources and cross-location staff rotation planned.",tp:"Operational",st:"active",
    depts:[
      {did:"d6",dn:"Aalborg Storcenter",layout:"lt1",areas:[
        {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:["AV Specialist Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
    ...
    rev:31000000,inv:3200000,sd:"Q1 2025",td:"Q2 2026",_skillRd:38,_certRd:30,
    sg:[{s:"AV Systems",n:6,i:"Critical"},{s:"Computer Setup",n:5,i:"Critical"},{s:"Product Knowledge",n:14,i:"High"},{s:"Mobile Setup",n:4,i:"High"},{s:"Customer Service",n:8,i:"Critical"},{s:"POS Operations",n:3,i:"High"}],
    cg:[{c:"AV Specialist Cert",n:4,i:"Critical",exp:"2025-09-01"},{c:"IT Support Cert",n:3,i:"High",exp:"2025-10-15"},{c:"Electrical Safety Cert",n:5,i:"Critical",exp:"2025-08-01"}],
  ...
  {id:"i4",nm:"Odense POWERHOUSE",ds:"Projected relocation of Odense City store to a new 3,200m\u00B2 POWERHOUSE concept. Triple the floor space with new departments including Smart Home experience zone and photo studio. Opening Q3 2026.",tp:"Operational",st:"projection",
    depts:[
      {did:"d4",dn:"Odense City",layout:"lt2",areas:[
        {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:5},{s:"Product Knowledge",lvl:4}],certReqs:["AV Specialist Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:2,ql:0,gp:2},
          {cid:"c4",cn:"Sales Advisor",cr:"Essential",rq:8,ql:0,gp:8}
        ]},
        {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:5},{s:"Network Basics",lvl:4}],certReqs:["IT Support Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:2,ql:0,gp:2},
        ...
        {aid:"a7",anm:"Smart Home & IoT",skillReqs:[{s:"Smart Home Setup",lvl:4},{s:"Network Basics",lvl:4}],certReqs:["Electrical Safety Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:0,gp:1},
        ...
        {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:["Electrical Safety Cert","Installer Cert"],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:5,ql:0,gp:5}
        ]},
        {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3},{s:"Customer Service",lvl:4}],certReqs:[],roles:[
    ...
    rev:68000000,inv:8500000,sd:"Q1 2026",td:"Q3 2026",_skillRd:0,_certRd:0,
    sg:[{s:"AV Systems",n:10,i:"Critical"},{s:"Computer Setup",n:8,i:"Critical"},{s:"Smart Home Setup",n:5,i:"Critical"},{s:"Product Knowledge",n:24,i:"High"},{s:"Customer Service",n:15,i:"Critical"},{s:"POS Operations",n:6,i:"High"},{s:"Camera Systems",n:3,i:"Medium"}],
    cg:[{c:"AV Specialist Cert",n:8,i:"Critical"},{c:"IT Support Cert",n:6,i:"Critical"},{c:"Electrical Safety Cert",n:10,i:"Critical"},{c:"Installer Cert",n:5,i:"High"}],
    certs:[],hist:[]
  },
  ...
  {id:"i5",nm:"HQ Digital Transformation",ds:"Back-office transformation at POWER HQ Ballerup. Upskilling the marketing, e-commerce, and support teams to handle the new omnichannel platform and AI-powered customer tools.",tp:"Administrative",st:"active",
    ...
    rev:0,inv:2100000,sd:"Q2 2025",td:"Q1 2026",_skillRd:65,_certRd:70,
    sg:[{s:"Data Analytics",n:4,i:"High"},{s:"Omnichannel Strategy",n:6,i:"Critical"},{s:"AI Tools",n:5,i:"High"},{s:"Team Leadership",n:2,i:"Medium"}],
    cg:[{c:"Google Analytics Cert",n:3,i:"High",exp:"2025-12-01"},{c:"Project Management Cert",n:2,i:"Medium",exp:"2026-01-15"}],
  ...
  {id:"i7",nm:"POWER Regional Rollout",ds:"Four POWER stores across Denmark. Roskilde and Frederiksberg are established top-performers. Aarhus Bruuns is being scaled up with a new Gaming department. Herning is a compact rural store without area divisions.",tp:"Operational",st:"active",
    ...
    rev:54000000,inv:2800000,sd:"Q1 2025",td:"Q4 2025",_skillRd:58,_certRd:52,
    sg:[{s:"Product Knowledge",n:14,i:"High"},{s:"Customer Service",n:10,i:"Critical"},{s:"Technical Sales",n:8,i:"High"},{s:"AV Systems",n:6,i:"Critical"},{s:"Computer Setup",n:5,i:"High"},{s:"Console Setup",n:4,i:"Medium"},{s:"Mobile Setup",n:3,i:"Medium"}],
    cg:[{c:"AV Specialist Cert",n:5,i:"Critical",exp:"2025-09-01"},{c:"IT Support Cert",n:3,i:"High",exp:"2025-10-15"},{c:"Electrical Safety Cert",n:4,i:"High",exp:"2025-11-01"}],
...
export var LAYOUT_TEMPLATES=[
  {id:"lt1",nm:"POWER Standard",areas:[
    {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:["AV Specialist Cert"]},
    {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:4},{s:"Network Basics",lvl:3}],certReqs:["IT Support Cert"]},
    {aid:"a3",anm:"Phones & Wearables",skillReqs:[{s:"Mobile Setup",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:[]},
    {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:["Electrical Safety Cert"]},
  ...
  {id:"lt2",nm:"POWERHOUSE XL",areas:[
    {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:5},{s:"Product Knowledge",lvl:4}],certReqs:["AV Specialist Cert"]},
    {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:5},{s:"Network Basics",lvl:4}],certReqs:["IT Support Cert"]},
    {aid:"a3",anm:"Phones & Wearables",skillReqs:[{s:"Mobile Setup",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:[]},
    {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:["Electrical Safety Cert","Installer Cert"]},
    {aid:"a5",anm:"Gaming",skillReqs:[{s:"Console Setup",lvl:4},{s:"Technical Sales",lvl:4}],certReqs:[]},
    {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3},{s:"Customer Service",lvl:4}],certReqs:[]},
    {aid:"a7",anm:"Smart Home & IoT",skillReqs:[{s:"Smart Home Setup",lvl:4},{s:"Network Basics",lvl:4}],certReqs:["Electrical Safety Cert"]},
...
export var FITS=[
  ...
  {nm:"Mikkel Thorsen",cur:"Sales Advisor - Lyngby, Computers",mp:88,tgt:"Department Lead",loc:"Lyngby",area:"Computers & Tablets",ms:["Team Leadership"],mc:[],hp:true,from:"i1",fLift:5,fCost:2},
  {nm:"Emma Soerensen",cur:"Sales Advisor - Lyngby, Kitchen",mp:72,tgt:"Department Lead",loc:"Lyngby",area:"Kitchen & Household",ms:["Appliance Installation","Team Leadership"],mc:["Installer Cert"],hp:false,from:"i1",fLift:4,fCost:3},
