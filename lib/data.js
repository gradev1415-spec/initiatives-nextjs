...
export function mkIni(){return [
  ...
  {id:"i1",nm:"Lyngby Flagship",ds:"Flagship POWER store in Lyngby shopping centre. Largest store in the Capital Region with full department coverage and dedicated service desk. Benchmark location for new concepts.",tp:"Operational",st:"active",
    depts:[
      {did:"d1",dn:"Lyngby",layout:"lt1",areas:[
        {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:4,cr:"Essential"},{s:"Product Knowledge",lvl:4,cr:"Important"}],certReqs:[{c:"AV Specialist Cert",cr:"Essential"}],roles:[
        ...
        {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:4,cr:"Essential"},{s:"Network Basics",lvl:3,cr:"Important"}],certReqs:[{c:"IT Support Cert",cr:"Important"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:6,ql:6,gp:0},
          {cid:"c5",cn:"Tech Support",cr:"Important",rq:2,ql:2,gp:0}
        ]},
        {aid:"a3",anm:"Phones & Wearables",skillReqs:[{s:"Mobile Setup",lvl:3,cr:"Important"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:4,ql:4,gp:0}
        ]},
        {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:3,cr:"Essential"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[{c:"Electrical Safety Cert",cr:"Essential"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:4,ql:4,gp:0}
        ]},
        {aid:"a5",anm:"Gaming",skillReqs:[{s:"Console Setup",lvl:3,cr:"Important"},{s:"Technical Sales",lvl:4,cr:"Essential"}],certReqs:[],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:3,ql:3,gp:0}
        ]},
        {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3,cr:"Essential"},{s:"Customer Service",lvl:4,cr:"Essential"}],certReqs:[],roles:[
  ...
  {id:"i2",nm:"Norreport City Store",ds:"Compact city-centre POWER express store at Norreport Station. High foot traffic, limited floor space, focused product selection. No separate departments — all staff rotate across the floor.",tp:"Operational",st:"active",
    ...
    sg:[{s:"Inventory Management",n:1,i:"Nice to have"}],cg:[],
  ...
  {id:"i3",nm:"West Coast Expansion",ds:"Two-store expansion into Aalborg Storcenter (ramping up, partially staffed) and Esbjerg Storcenter (newly opened, critical gaps). Shared training resources and cross-location staff rotation planned.",tp:"Operational",st:"active",
    depts:[
      {did:"d6",dn:"Aalborg Storcenter",layout:"lt1",areas:[
        {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:4,cr:"Essential"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[{c:"AV Specialist Cert",cr:"Essential"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:1,gp:0},
        ...
        {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3,cr:"Essential"},{s:"Customer Service",lvl:3,cr:"Essential"}],certReqs:[],roles:[
    ...
    sg:[{s:"AV Systems",n:6,i:"Essential"},{s:"Computer Setup",n:5,i:"Essential"},{s:"Product Knowledge",n:14,i:"Important"},{s:"Mobile Setup",n:4,i:"Important"},{s:"Customer Service",n:8,i:"Essential"},{s:"POS Operations",n:3,i:"Important"}],
    cg:[{c:"AV Specialist Cert",n:4,i:"Essential",exp:"2025-09-01"},{c:"IT Support Cert",n:3,i:"Important",exp:"2025-10-15"},{c:"Electrical Safety Cert",n:5,i:"Essential",exp:"2025-08-01"}],
  ...
  {id:"i4",nm:"Odense POWERHOUSE",ds:"Projected relocation of Odense City store to a new 3,200m\u00B2 POWERHOUSE concept. Triple the floor space with new departments including Smart Home experience zone and photo studio. Opening Q3 2026.",tp:"Operational",st:"projection",
    depts:[
      {did:"d4",dn:"Odense City",layout:"lt2",areas:[
        {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:5,cr:"Essential"},{s:"Product Knowledge",lvl:4,cr:"Important"}],certReqs:[{c:"AV Specialist Cert",cr:"Essential"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:2,ql:0,gp:2},
          {cid:"c4",cn:"Sales Advisor",cr:"Essential",rq:8,ql:0,gp:8}
        ]},
        {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:5,cr:"Essential"},{s:"Network Basics",lvl:4,cr:"Important"}],certReqs:[{c:"IT Support Cert",cr:"Important"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:2,ql:0,gp:2},
          {cid:"c4",cn:"Sales Advisor",cr:"Essential",rq:6,ql:0,gp:6},
          {cid:"c5",cn:"Tech Support",cr:"Important",rq:3,ql:0,gp:3}
        ]},
        {aid:"a3",anm:"Phones & Wearables",skillReqs:[{s:"Mobile Setup",lvl:4,cr:"Important"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:5,ql:0,gp:5}
        ]},
        {aid:"a7",anm:"Smart Home & IoT",skillReqs:[{s:"Smart Home Setup",lvl:4,cr:"Essential"},{s:"Network Basics",lvl:4,cr:"Important"}],certReqs:[{c:"Electrical Safety Cert",cr:"Essential"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:4,ql:0,gp:4},
          {cid:"c5",cn:"Tech Support",cr:"Important",rq:1,ql:0,gp:1}
        ]},
        {aid:"a8",anm:"Photo & Video",skillReqs:[{s:"Camera Systems",lvl:4,cr:"Nice to have"},{s:"Product Knowledge",lvl:3,cr:"Nice to have"}],certReqs:[],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Important",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Advisor",cr:"Nice to have",rq:2,ql:0,gp:2}
        ]},
        {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:4,cr:"Essential"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[{c:"Electrical Safety Cert",cr:"Essential"},{c:"Installer Cert",cr:"Important"}],roles:[
          {cid:"c3",cn:"Department Lead",cr:"Essential",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Advisor",cr:"Important",rq:5,ql:0,gp:5}
        ]},
        {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3,cr:"Essential"},{s:"Customer Service",lvl:4,cr:"Essential"}],certReqs:[],roles:[
    ...
    sg:[{s:"AV Systems",n:10,i:"Essential"},{s:"Computer Setup",n:8,i:"Essential"},{s:"Smart Home Setup",n:5,i:"Essential"},{s:"Product Knowledge",n:24,i:"Important"},{s:"Customer Service",n:15,i:"Essential"},{s:"POS Operations",n:6,i:"Important"},{s:"Camera Systems",n:3,i:"Nice to have"}],
    cg:[{c:"AV Specialist Cert",n:8,i:"Essential"},{c:"IT Support Cert",n:6,i:"Essential"},{c:"Electrical Safety Cert",n:10,i:"Essential"},{c:"Installer Cert",n:5,i:"Important"}],
    certs:[],hist:[]
  },
  ...
  {id:"i5",nm:"HQ Digital Transformation",ds:"Back-office transformation at POWER HQ Ballerup. Upskilling the marketing, e-commerce, and support teams to handle the new omnichannel platform and AI-powered customer tools.",tp:"Administrative",st:"active",
    ...
    sg:[{s:"Data Analytics",n:4,i:"Important"},{s:"Omnichannel Strategy",n:6,i:"Essential"},{s:"AI Tools",n:5,i:"Important"},{s:"Team Leadership",n:2,i:"Nice to have"}],
    cg:[{c:"Google Analytics Cert",n:3,i:"Important",exp:"2025-12-01"},{c:"Project Management Cert",n:2,i:"Nice to have",exp:"2026-01-15"}],
  ...
  {id:"i7",nm:"POWER Regional Rollout",ds:"Four POWER stores across Denmark. Roskilde and Frederiksberg are established top-performers. Aarhus Bruuns is being scaled up with a new Gaming department. Herning is a compact rural store without area divisions.",tp:"Operational",st:"active",
    ...
    sg:[{s:"Product Knowledge",n:14,i:"Important"},{s:"Customer Service",n:10,i:"Essential"},{s:"Technical Sales",n:8,i:"Important"},{s:"AV Systems",n:6,i:"Essential"},{s:"Computer Setup",n:5,i:"Important"},{s:"Console Setup",n:4,i:"Nice to have"},{s:"Mobile Setup",n:3,i:"Nice to have"}],
    cg:[{c:"AV Specialist Cert",n:5,i:"Essential",exp:"2025-09-01"},{c:"IT Support Cert",n:3,i:"Important",exp:"2025-10-15"},{c:"Electrical Safety Cert",n:4,i:"Important",exp:"2025-11-01"}],
...
export var LAYOUT_TEMPLATES=[
  {id:"lt1",nm:"POWER Standard",areas:[
    {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:4,cr:"Essential"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[{c:"AV Specialist Cert",cr:"Essential"}]},
    {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:4,cr:"Essential"},{s:"Network Basics",lvl:3,cr:"Important"}],certReqs:[{c:"IT Support Cert",cr:"Important"}]},
    {aid:"a3",anm:"Phones & Wearables",skillReqs:[{s:"Mobile Setup",lvl:3,cr:"Important"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[]},
    {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:3,cr:"Essential"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[{c:"Electrical Safety Cert",cr:"Essential"}]},
    {aid:"a5",anm:"Gaming",skillReqs:[{s:"Console Setup",lvl:3,cr:"Important"},{s:"Technical Sales",lvl:4,cr:"Essential"}],certReqs:[]},
    {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3,cr:"Essential"},{s:"Customer Service",lvl:4,cr:"Essential"}],certReqs:[]}
  ]},
  {id:"lt2",nm:"POWERHOUSE XL",areas:[
    {aid:"a1",anm:"TV & Hi-Fi",skillReqs:[{s:"AV Systems",lvl:5,cr:"Essential"},{s:"Product Knowledge",lvl:4,cr:"Important"}],certReqs:[{c:"AV Specialist Cert",cr:"Essential"}]},
    {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:5,cr:"Essential"},{s:"Network Basics",lvl:4,cr:"Important"}],certReqs:[{c:"IT Support Cert",cr:"Important"}]},
    {aid:"a3",anm:"Phones & Wearables",skillReqs:[{s:"Mobile Setup",lvl:4,cr:"Important"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[]},
    {aid:"a4",anm:"Kitchen & Household",skillReqs:[{s:"Appliance Installation",lvl:4,cr:"Essential"},{s:"Product Knowledge",lvl:3,cr:"Important"}],certReqs:[{c:"Electrical Safety Cert",cr:"Essential"},{c:"Installer Cert",cr:"Important"}]},
    {aid:"a5",anm:"Gaming",skillReqs:[{s:"Console Setup",lvl:4,cr:"Important"},{s:"Technical Sales",lvl:4,cr:"Essential"}],certReqs:[]},
    {aid:"a6",anm:"Checkout & Service",skillReqs:[{s:"POS Operations",lvl:3,cr:"Essential"},{s:"Customer Service",lvl:4,cr:"Essential"}],certReqs:[]},
    {aid:"a7",anm:"Smart Home & IoT",skillReqs:[{s:"Smart Home Setup",lvl:4,cr:"Essential"},{s:"Network Basics",lvl:4,cr:"Important"}],certReqs:[{c:"Electrical Safety Cert",cr:"Essential"}]},
    {aid:"a8",anm:"Photo & Video",skillReqs:[{s:"Camera Systems",lvl:4,cr:"Nice to have"},{s:"Product Knowledge",lvl:3,cr:"Nice to have"}],certReqs:[]}
  ]}
];
