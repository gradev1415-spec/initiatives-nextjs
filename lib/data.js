...
export var CAPABILITY_SETS=[
  {id:"cs1",nm:"AV Competency",desc:"Skills and certifications for TV, Hi-Fi, and home cinema departments.",
   skillReqs:[{s:"AV Systems",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:[{c:"AV Specialist Cert"}]},
  {id:"cs2",nm:"IT & Computing",desc:"Skills for computers, tablets, and networking support.",
   skillReqs:[{s:"Computer Setup",lvl:4},{s:"Network Basics",lvl:3}],certReqs:[{c:"IT Support Cert"}]},
  {id:"cs3",nm:"Mobile Devices",desc:"Skills for phones, wearables, and mobile setup.",
   skillReqs:[{s:"Mobile Setup",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:[]},
  {id:"cs4",nm:"Appliance & Household",desc:"Skills for kitchen appliances, household goods, and installation.",
   skillReqs:[{s:"Appliance Installation",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:[{c:"Electrical Safety Cert"}]},
  {id:"cs5",nm:"Gaming",desc:"Skills for gaming consoles, accessories, and technical sales.",
   skillReqs:[{s:"Console Setup",lvl:3},{s:"Technical Sales",lvl:4}],certReqs:[]},
  {id:"cs6",nm:"Customer Service & Checkout",desc:"Skills for POS operations, returns, and front-of-house service.",
   skillReqs:[{s:"POS Operations",lvl:3},{s:"Customer Service",lvl:4}],certReqs:[]},
  {id:"cs7",nm:"Smart Home & IoT",desc:"Skills for smart home devices, IoT setup, and home networking.",
   skillReqs:[{s:"Smart Home Setup",lvl:4},{s:"Network Basics",lvl:4}],certReqs:[{c:"Electrical Safety Cert"}]},
  {id:"cs8",nm:"Photo & Video",desc:"Skills for cameras, video equipment, and imaging products.",
