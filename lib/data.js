...
export var LAYOUT_TEMPLATES=[
  {id:"lt1",nm:"POWER Standard",areas:[
    {aid:"a1",anm:"Radio & TV"},
    {aid:"a2",anm:"Computers & Tablets"},
    {aid:"a3",anm:"Kitchen Appliances"},
    {aid:"a4",anm:"Gaming & Accessories"},
    {aid:"a5",anm:"Personal Care & Beauty"}
  ]}
];
