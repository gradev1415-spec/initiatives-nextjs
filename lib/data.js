...
export function mkIni(){return [
  ...
  {id:"i7",nm:"POWER Roskilde + Hillerød",ds:"Two POWER electronics stores. Roskilde is the full flagship with 5 areas. Hillerød is a smaller footprint without dedicated areas.",tp:"Operational",st:"active",
    depts:[
      {did:"d7",dn:"Roskilde",layout:"lt1",areas:[
        {aid:"a1",anm:"Radio & TV",skillReqs:[{s:"AV Systems",lvl:3},{s:"Product Knowledge",lvl:2}],certReqs:["AV Technician"],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:4,ql:3,gp:1}
        ]},
        {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:3},{s:"Network Basics",lvl:2}],certReqs:["Electronics Safety"],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:5,ql:4,gp:1}
        ]},
        {aid:"a3",anm:"Kitchen Appliances",skillReqs:[{s:"Kitchen Appliance Demo",lvl:2},{s:"Product Knowledge",lvl:1}],certReqs:["Electronics Safety"],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:3,ql:2,gp:1}
        ]},
        {aid:"a4",anm:"Gaming & Accessories",skillReqs:[{s:"Console Setup",lvl:2},{s:"Technical Sales",lvl:2}],certReqs:[],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:3,ql:3,gp:0}
        ]},
        {aid:"a5",anm:"Personal Care & Beauty",skillReqs:[{s:"Beauty Advisory",lvl:1}],certReqs:["Product Specialist"],roles:[
    ...
    rev:28000000,sd:"Q1 2025",td:"Q4 2025",_skillRd:72,_certRd:65,
    sg:[{s:"Product Knowledge",n:5,i:"High"},{s:"Customer Service",n:3,i:"Critical"},{s:"Technical Sales",n:4,i:"High"}],
    cg:[{c:"Electronics Safety",n:2,i:"High",exp:"2025-08-01"}],
    certs:[{c:"Electronics Safety",total:22,valid:18,exp30:2,exp60:1,expired:1}],
    hist:[{q:"Q1 2025",rd:65,staff:70,skill:62,cert:58},{q:"Q2 2025",rd:74,staff:78,skill:72,cert:65}]
  }
];}

export var LAYOUT_TEMPLATES=[
  {id:"lt1",nm:"POWER Standard",areas:[
    {aid:"a1",anm:"Radio & TV",skillReqs:[{s:"AV Systems",lvl:3},{s:"Product Knowledge",lvl:2}],certReqs:["AV Technician"]},
    {aid:"a2",anm:"Computers & Tablets",skillReqs:[{s:"Computer Setup",lvl:3},{s:"Network Basics",lvl:2}],certReqs:["Electronics Safety"]},
    {aid:"a3",anm:"Kitchen Appliances",skillReqs:[{s:"Kitchen Appliance Demo",lvl:2},{s:"Product Knowledge",lvl:1}],certReqs:["Electronics Safety"]},
    {aid:"a4",anm:"Gaming & Accessories",skillReqs:[{s:"Console Setup",lvl:2},{s:"Technical Sales",lvl:2}],certReqs:[]},
    {aid:"a5",anm:"Personal Care & Beauty",skillReqs:[{s:"Beauty Advisory",lvl:1}],certReqs:["Product Specialist"]}
  ]}
];
