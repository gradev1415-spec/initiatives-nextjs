  ...
  {id:"i7",nm:"POWER Roskilde + Hillerød",ds:"Two POWER electronics stores. Roskilde is the full flagship with 5 areas. Hillerød is a smaller footprint without dedicated areas.",tp:"Operational",st:"active",
    depts:[
      {did:"d7",dn:"Roskilde",layout:"lt1",areas:[
        {aid:"a1",anm:"Radio & TV",skillReqs:["AV Systems","Product Knowledge"],certReqs:["AV Technician"],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:4,ql:3,gp:1}
        ]},
        {aid:"a2",anm:"Computers & Tablets",skillReqs:["Computer Setup","Network Basics"],certReqs:["Electronics Safety"],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:5,ql:4,gp:1}
        ]},
        {aid:"a3",anm:"Kitchen Appliances",skillReqs:["Kitchen Appliance Demo","Product Knowledge"],certReqs:["Electronics Safety"],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:1,gp:0},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:3,ql:2,gp:1}
        ]},
        {aid:"a4",anm:"Gaming & Accessories",skillReqs:["Console Setup","Technical Sales"],certReqs:[],roles:[
          {cid:"c3",cn:"Team Leader",cr:"Essential",rq:1,ql:0,gp:1},
          {cid:"c4",cn:"Sales Assistant",cr:"Important",rq:3,ql:3,gp:0}
        ]},
        {aid:"a5",anm:"Personal Care & Beauty",skillReqs:["Beauty Advisory"],certReqs:["Product Specialist"],roles:[
...
export var LAYOUT_TEMPLATES=[
  {id:"lt1",nm:"POWER Standard",areas:[
    {aid:"a1",anm:"Radio & TV",skillReqs:["AV Systems","Product Knowledge"],certReqs:["AV Technician"]},
    {aid:"a2",anm:"Computers & Tablets",skillReqs:["Computer Setup","Network Basics"],certReqs:["Electronics Safety"]},
    {aid:"a3",anm:"Kitchen Appliances",skillReqs:["Kitchen Appliance Demo","Product Knowledge"],certReqs:["Electronics Safety"]},
    {aid:"a4",anm:"Gaming & Accessories",skillReqs:["Console Setup","Technical Sales"],certReqs:[]},
    {aid:"a5",anm:"Personal Care & Beauty",skillReqs:["Beauty Advisory"],certReqs:["Product Specialist"]}
  ]}
];
