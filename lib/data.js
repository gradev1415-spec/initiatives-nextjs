...
export var LAYOUT_TEMPLATES=[
  {id:"lt1",nm:"POWER Standard",areas:[
    {aid:"a1",anm:"TV & Hi-Fi",capSetId:"cs1"},
    {aid:"a2",anm:"Computers & Tablets",capSetId:"cs2"},
    {aid:"a3",anm:"Phones & Wearables",capSetId:"cs3"},
    {aid:"a4",anm:"Kitchen & Household",capSetId:"cs4"},
    {aid:"a5",anm:"Gaming",capSetId:"cs5"},
    {aid:"a6",anm:"Checkout & Service",capSetId:"cs6"}
  ]},
  {id:"lt2",nm:"POWERHOUSE XL",areas:[
    {aid:"a1",anm:"TV & Hi-Fi",capSetId:"cs1",lvlAdj:1},
    {aid:"a2",anm:"Computers & Tablets",capSetId:"cs2",lvlAdj:1},
    {aid:"a3",anm:"Phones & Wearables",capSetId:"cs3",lvlAdj:1},
    {aid:"a4",anm:"Kitchen & Household",capSetId:"cs4",lvlAdj:1,certReqsExtra:[{c:"Installer Cert"}]},
    {aid:"a5",anm:"Gaming",capSetId:"cs5",lvlAdj:1},
    {aid:"a6",anm:"Checkout & Service",capSetId:"cs6"},
    {aid:"a7",anm:"Smart Home & IoT",capSetId:"cs7"},
    {aid:"a8",anm:"Photo & Video",capSetId:"cs8"}
  ]}
];
...
/* ——— Function Presets (templates for quick set creation) ——— */
export var FUNCTION_PRESETS=[
  {id:"fp1",nm:"Home Cinema & AV",icon:"📺",desc:"TV, Hi-Fi, and home cinema department staff.",lane:"ln1",reqHc:20,
   skillReqs:[{s:"AV Systems",lvl:4},{s:"Product Knowledge",lvl:3},{s:"Technical Sales",lvl:3}],certReqs:[{c:"AV Specialist Cert"}]},
  {id:"fp2",nm:"Computing & IT Support",icon:"💻",desc:"Computers, tablets, networking, and tech support.",lane:"ln2",reqHc:15,
   skillReqs:[{s:"Computer Setup",lvl:4},{s:"Network Basics",lvl:3},{s:"Customer Service",lvl:3}],certReqs:[{c:"IT Support Cert"}]},
  {id:"fp3",nm:"Mobile & Wearables",icon:"📱",desc:"Phones, wearables, and connected devices.",lane:"ln1",reqHc:20,
   skillReqs:[{s:"Mobile Setup",lvl:3},{s:"Product Knowledge",lvl:3},{s:"Customer Service",lvl:3}],certReqs:[]},
  {id:"fp4",nm:"Kitchen & Large Appliance",icon:"🍳",desc:"Kitchen appliances, white goods, and installation services.",lane:"ln1",reqHc:12,
   skillReqs:[{s:"Appliance Installation",lvl:3},{s:"Product Knowledge",lvl:3},{s:"Electrical Safety",lvl:3}],certReqs:[{c:"Electrical Safety Cert"},{c:"Installer Cert"}]},
  {id:"fp5",nm:"Smart Home Specialist",icon:"🏠",desc:"IoT devices, home automation, and connected ecosystems.",lane:"ln2",reqHc:10,
   skillReqs:[{s:"Smart Home Setup",lvl:4},{s:"Network Basics",lvl:4},{s:"Technical Sales",lvl:3}],certReqs:[{c:"Electrical Safety Cert"}]},
  {id:"fp6",nm:"Checkout & Service Desk",icon:"🛒",desc:"POS operations, returns, customer service, and front-of-house.",lane:"ln3",reqHc:30,
   skillReqs:[{s:"POS Operations",lvl:3},{s:"Customer Service",lvl:4}],certReqs:[]},
  {id:"fp7",nm:"Warehouse & Logistics",icon:"📦",desc:"Stock management, receiving, and order fulfilment.",lane:"ln3",reqHc:15,
   skillReqs:[{s:"Inventory Management",lvl:4},{s:"Appliance Installation",lvl:2}],certReqs:[{c:"Electrical Safety Cert"}]},
  {id:"fp8",nm:"Store Leadership",icon:"👔",desc:"Store managers and assistant managers across all departments.",lane:"ln3",reqHc:8,
   skillReqs:[{s:"Team Leadership",lvl:5},{s:"Customer Service",lvl:4},{s:"Product Knowledge",lvl:4},{s:"Inventory Management",lvl:3}],certReqs:[{c:"Electrical Safety Cert"},{c:"Project Management Cert"}]},
  {id:"fp9",nm:"Photography & Video",icon:"📷",desc:"Cameras, video equipment, drones, and imaging products.",lane:"ln1",reqHc:6,
   skillReqs:[{s:"Camera Systems",lvl:4},{s:"Product Knowledge",lvl:3},{s:"Technical Sales",lvl:3}],certReqs:[]},
  {id:"fp10",nm:"Gaming & Esports",icon:"🎮",desc:"Consoles, PC gaming, accessories, and esports gear.",lane:"ln1",reqHc:8,
   skillReqs:[{s:"Console Setup",lvl:3},{s:"Technical Sales",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:[]}
];

/* ——— Capability Set Swimlanes ——— */
export var CAPABILITY_LANES=[
  {id:"ln1",nm:"Sales Floor",clr:"#3182CE"},
  {id:"ln2",nm:"Technical",clr:"#9F7AEA"},
  {id:"ln3",nm:"Operations",clr:"#DD6B20"}
];

/* ——— Capability Sets ——— */
export var CAPABILITY_SETS=[
  {id:"cs1",nm:"AV Competency",desc:"Skills and certifications for TV, Hi-Fi, and home cinema departments.",lane:"ln1",reqHc:30,
   skillReqs:[{s:"AV Systems",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:[{c:"AV Specialist Cert"}]},
  {id:"cs2",nm:"IT & Computing",desc:"Skills for computers, tablets, and networking support.",lane:"ln2",reqHc:20,
   skillReqs:[{s:"Computer Setup",lvl:4},{s:"Network Basics",lvl:3}],certReqs:[{c:"IT Support Cert"}]},
  {id:"cs3",nm:"Mobile Devices",desc:"Skills for phones, wearables, and mobile setup.",lane:"ln1",reqHc:25,
   skillReqs:[{s:"Mobile Setup",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:[]},
  {id:"cs4",nm:"Appliance & Household",desc:"Skills for kitchen appliances, household goods, and installation.",lane:"ln1",reqHc:15,
   skillReqs:[{s:"Appliance Installation",lvl:3},{s:"Product Knowledge",lvl:3}],certReqs:[{c:"Electrical Safety Cert"}]},
  {id:"cs5",nm:"Gaming",desc:"Skills for gaming consoles, accessories, and technical sales.",lane:"ln1",reqHc:10,
   skillReqs:[{s:"Console Setup",lvl:3},{s:"Technical Sales",lvl:4}],certReqs:[]},
  {id:"cs6",nm:"Customer Service & Checkout",desc:"Skills for POS operations, returns, and front-of-house service.",lane:"ln3",reqHc:40,
   skillReqs:[{s:"POS Operations",lvl:3},{s:"Customer Service",lvl:4}],certReqs:[]},
  {id:"cs7",nm:"Smart Home & IoT",desc:"Skills for smart home devices, IoT setup, and home networking.",lane:"ln2",reqHc:12,
   skillReqs:[{s:"Smart Home Setup",lvl:4},{s:"Network Basics",lvl:4}],certReqs:[{c:"Electrical Safety Cert"}]},
  {id:"cs8",nm:"Photo & Video",desc:"Skills for cameras, video equipment, and imaging products.",lane:"ln1",reqHc:8,
   skillReqs:[{s:"Camera Systems",lvl:4},{s:"Product Knowledge",lvl:3}],certReqs:[]}
];

/* Resolve an area's effective skillReqs and certReqs from its capability set reference.
   Falls back to inline skillReqs/certReqs for legacy data. */
export function resolveAreaReqs(area,capSets){
  if(!area.capSetId){return {skillReqs:area.skillReqs||[],certReqs:area.certReqs||[]};}
  var set=(capSets||[]).find(function(cs){return cs.id===area.capSetId;});
  if(!set)return {skillReqs:[],certReqs:[]};
  var adj=area.lvlAdj||0;
  var skillReqs=set.skillReqs.map(function(sk){return {s:sk.s,lvl:Math.min(5,Math.max(1,sk.lvl+adj))};});
  var certReqs=(set.certReqs||[]).slice();
  if(area.certReqsExtra)certReqs=certReqs.concat(area.certReqsExtra);
  return {skillReqs:skillReqs,certReqs:certReqs};
}

/* Hydrate an area: resolve capSetId into inline skillReqs/certReqs + add _capSetNm */
export function hydrateArea(area,capSets){
  if(!area.capSetId)return area;
  var resolved=resolveAreaReqs(area,capSets);
  var set=(capSets||[]).find(function(cs){return cs.id===area.capSetId;});
  var out={};for(var k in area)out[k]=area[k];
  out.skillReqs=resolved.skillReqs;
  out.certReqs=resolved.certReqs;
  out._capSetNm=set?set.nm:null;
  return out;
}

/* Hydrate an entire initiative: resolve all area capSetId references */
export function hydrateIni(ini,capSets){
  var out={};for(var k in ini)out[k]=ini[k];
  out.depts=ini.depts.map(function(d){
    if(!d.areas)return d;
    var d2={};for(var k in d)d2[k]=d[k];
    d2.areas=d.areas.map(function(a){return hydrateArea(a,capSets);});
    return d2;
  });
  return out;
}

/* ——— Company-wide matching engine ——— */
export function totalWorkforce(jpSkills){
  var t=0;for(var k in jpSkills)t+=jpSkills[k].hc;return t;
}

export function matchCapSet(capSet,jpSkills){
  var total=totalWorkforce(jpSkills);
  if(!total)return {readiness:0,pool:0,fullMatch:0,total:0,skills:[],certs:[]};

  /* Per-skill breakdown */
  var skills=capSet.skillReqs.map(function(req){
    var have=0;
    for(var k in jpSkills){
      var jp=jpSkills[k];
      var found=jp.skills.find(function(s){return s.s===req.s;});
      if(found&&found.lvl>=req.lvl) have+=found.have;
    }
    return {s:req.s,reqLvl:req.lvl,have:have,total:total,pct:Math.round(have/total*100)};
  });

  /* Per-cert breakdown */
  var certs=capSet.certReqs.map(function(req){
    var have=0;
    for(var k in jpSkills){
      var jp=jpSkills[k];
      var found=jp.certs.find(function(c){return c.c===req.c;});
      if(found) have+=found.have;
    }
    return {c:req.c,have:have,total:total,pct:Math.round(have/total*100)};
  });

  /* Pool: profiles with at least 1 matching skill or cert */
  var pool=0;
  for(var k in jpSkills){
    var jp=jpSkills[k];
    var hasAny=capSet.skillReqs.some(function(req){
      return jp.skills.some(function(s){return s.s===req.s&&s.lvl>=req.lvl;});
    })||capSet.certReqs.some(function(req){
      return jp.certs.some(function(c){return c.c===req.c;});
    });
    if(hasAny) pool+=jp.hc;
  }

  /* Full match: profiles meeting ALL requirements */
  var fullMatch=0;
  for(var k in jpSkills){
    var jp=jpSkills[k];
    var allSkills=capSet.skillReqs.every(function(req){
      return jp.skills.some(function(s){return s.s===req.s&&s.lvl>=req.lvl;});
    });
    var allCerts=capSet.certReqs.every(function(req){
      return jp.certs.some(function(c){return c.c===req.c;});
    });
    if(allSkills&&allCerts) fullMatch+=jp.hc;
  }

  /* Readiness: weighted average of skill + cert coverage */
  var skillAvg=skills.length?skills.reduce(function(a,s){return a+Math.min(s.pct,100);},0)/skills.length:100;
  var certAvg=certs.length?certs.reduce(function(a,c){return a+Math.min(c.pct,100);},0)/certs.length:100;
  var readiness=certs.length?Math.round(skillAvg*0.7+certAvg*0.3):Math.round(skillAvg);

  return {readiness:readiness,pool:pool,fullMatch:fullMatch,total:total,skills:skills,certs:certs};
}

export function matchAllCapSets(capSets,jpSkills){
  var m={};capSets.forEach(function(cs){m[cs.id]=matchCapSet(cs,jpSkills);});return m;
}
