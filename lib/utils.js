...
export function ic2(i, T) { return (i === "Critical" || i === "Essential") ? T.rd : (i === "High" || i === "Important") ? T.am : (i === "Medium" || i === "Nice to have") ? T.ac : T.td; }
...
export function forEachRole(depts, fn) {
  depts.forEach(function(d) {
    if (d.areas) {
      d.areas.forEach(function(a) {
        (a.roles || []).forEach(function(r) { fn(r, d, a); });
      });
    } else {
      (d.roles || []).forEach(function(r) { fn(r, d, null); });
    }
  });
}
